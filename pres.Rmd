...
## Life Expectance in Americas - Bar Plot
...
## Income Per Person Vs Life Expectancy in 2007
...
gapminder %>% filter(continent != "Oceania", year == 2007) %>%
  ...
  labs(x = "Income per person", y = "Life expectancy")

```


## Income Per Person Vs Life Expectancy across years
...
gapminder %>% filter(country == "Kuwait") %>% 
  ...
  geom_line(color = "red") + 
  geom_point() +
  labs(x = "Year", y = "Income per person") + 
  theme_bw()

```

## Life Expectancy of Kuwait
